                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-8">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <span className="text-xl font-bold text-foreground">
                            Sonthi<span className="text-primary">Shop</span>
                        </span>
                    </div>

                    {/* Links */}
                    <div className="flex flex-wrap gap-8">
                        <Link href="/" className="text-muted-foreground hover:text-foreground text-sm transition-colors">หน้าแรก</Link>
                        <Link href="/products" className="text-muted-foreground hover:text-foreground text-sm transition-colors">สินค้า</Link>
                        <Link href="/about" className="text-muted-foreground hover:text-foreground text-sm transition-colors">เกี่ยวกับเรา</Link>
                        <Link href="/contact" className="text-muted-foreground hover:text-foreground text-sm transition-colors">ติดต่อ</Link>
                    </div>
                </div>
            </div>
